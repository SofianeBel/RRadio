...
export const fr = {
  ...
  hud: {
    ...
    settingsTooltip: 'Paramètres (Touche F10)',
  ...
  providerData: {
    ...
    libertyCityRadio: {
      name: 'STATIONS LIBERTY CITY',
      badge: 'RADIOS GTA',
      tagline: 'Toutes les musiques des radios de Liberty City disponibles à la demande'
    },
    spotify: {
      name: 'SPOTIFY',
      badge: 'COMING SOON',
  ...
  controlsBar: {
    ...
    gta6Hud: 'BANDEAU HUD',
    gta6HudTooltip: 'Bandeau de cartes carrées en haut',
    arcWheel: 'ROUE ARC',
  ...
  phone: {
    ...
    left: 'Naviguer à gauche',
    right: 'Naviguer à droite',
    activate: 'Ouvrir la sélection',
    end: 'Fermer le téléphone',
    shortcuts: 'Raccourcis des applications',
    keypad: 'Clavier de navigation',
    keyboardHint: 'Flèches : naviguer · Entrée : choisir · Échap : retour',
    radioHint: 'Choisissez votre fréquence',
    homeHint: 'Votre musique. Votre ville.',
    noStations: 'Aucune station disponible',
    noTrack: 'Aucun titre en cours',
    chooseStation: 'Choisir une station',
    currentStation: 'Station sélectionnée',
    live: 'Radio en direct',
    muted: 'Son coupé',
    mute: 'Couper le son',
    unmute: 'Activer le son',
    lowerVolume: 'Baisser le volume',
    raiseVolume: 'Augmenter le volume',
    volumeHint: 'Le volume est partagé avec la radio',
    progress: 'Progression du titre',
    durationUnknown: 'Durée inconnue',
    listening: 'Source audio',
  },
  tray: {
...
export const en: Translations = {
  ...
  hud: {
    ...
    settingsTooltip: 'Settings (Key F10)',
  ...
  providerData: {
    ...
    libertyCityRadio: {
      name: 'LIBERTY CITY STATIONS',
      badge: 'GTA RADIOS',
      tagline: 'All songs from Liberty City radio stations available on-demand'
    },
    spotify: {
      name: 'SPOTIFY',
      badge: 'COMING SOON',
  ...
  controlsBar: {
    ...
    muteTooltip: 'Mute (M)',
    gta6Hud: 'RIBBON HUD',
    gta6HudTooltip: 'Top square-card ribbon',
    arcWheel: 'ARC WHEEL',
  ...
  phone: {
    ...
    activate: 'Open selection',
    end: 'Close phone',
    shortcuts: 'App shortcuts',
    keypad: 'Navigation keypad',
    keyboardHint: 'Arrows: navigate · Enter: select · Esc: back',
    radioHint: 'Find your frequency',
    homeHint: 'Your music. Your city.',
    noStations: 'No stations available',
    noTrack: 'Nothing playing yet',
    chooseStation: 'Choose a station',
    currentStation: 'Selected station',
    live: 'Live radio',
    muted: 'Muted',
    mute: 'Mute',
    unmute: 'Unmute',
    ...
    volumeHint: 'Volume is shared with the radio',
